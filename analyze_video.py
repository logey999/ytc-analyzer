...
header .subtitle {{ font-size: 0.82rem; opacity: .8; }}
...
.no-data {{ color: var(--muted); font-size: .88rem; padding: 16px 0; }}
...
.rank       {{ color: var(--muted); font-size: .8rem; width: 36px; }}
.col-author {{ color: var(--blue); font-weight: 600; width: 140px; word-break: break-word; }}
.col-likes  {{ color: var(--red);  font-weight: 700; width: 70px; white-space: nowrap; }}
.col-text   {{ line-height: 1.5; }}
